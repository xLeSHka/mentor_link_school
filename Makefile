...
run:
	...
	go test  ./internal/tests/e2e_test.go -timeout 120s  -v -coverpkg='./internal/...' -coverprofile cover.out.tmp && cat cover.out.tmp > cover.out && rm cover.out.tmp && go tool cover -func cover.out
stop:
